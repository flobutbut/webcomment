          ...
          <div className="text-center py-4">
            ...
            {mode === 'signup' && (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg bg-white hover:bg-zinc-100 active:bg-zinc-200 text-black text-sm font-semibold transition-colors mb-4"
              >
